...
#import dataset
Amazon_UK <- read_csv("../../gen/data-preparation/AmazonData.csv")
```
...
```{r warning=FALSE, include=FALSE}
#Save dataset as CSV
write.csv(Amazon_UK, file = "../../gen/data-preparation/AmazonData.csv")
write.csv(Amazon_UK_Top10, file = "../../gen/data-preparation/AmazonDataTop10.csv")
```